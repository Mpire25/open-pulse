...
function buildInstructions(options: { fastContext: boolean; researchEnabled: boolean }): string {
  ...
  const researchInstructions = options.researchEnabled
    ...
    : 'External web research is intentionally unavailable for this request because it can be answered from personal health data alone. Do not claim that you searched the web or delay the answer for external evidence.'
